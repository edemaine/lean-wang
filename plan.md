...
folded simulation rows. The remaining equality proof should use the row
read-back invariant plus a uniqueness/no-duplicate fact for the TM0 label
support list, or replace the semantic state-code dependency directly.
