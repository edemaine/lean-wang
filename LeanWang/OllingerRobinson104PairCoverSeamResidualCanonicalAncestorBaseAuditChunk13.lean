...
/-! Cached even and odd base-ancestor checks for parents 52 through 55. -/

namespace LeanWang.OllingerRobinson.Figure13Layers.Closed104
namespace PairCoverSeamResidualCanonicalAncestorBaseAudit

set_option linter.style.nativeDecide false in
theorem completeEven13 : ∀ parent : Index, 52 ≤ parent.val → parent.val < 56 →
    checkParent .even parent = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd13 : ∀ parent : Index, 52 ≤ parent.val → parent.val < 56 →
