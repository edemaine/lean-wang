...
/-! Cached exceptional family-target checks for parents 4 through 7. -/
...
theorem completeEven01 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨1, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd01 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨1, by decide⟩ = true := by
  native_decide
