...
/--
Encoded domino undecidability from the finite-check-facing Robinson Section 7
board/free-line layer-patch obligation and generated position-coded
source-route obligations.
-/
theorem
  ...
  exact
    encoded_domino_problem_undecidable_of_figure13_compatible_level_obligations_position_source
      activeSiteSpecs activeSiteSpecs_valid cornerIndex cornerQuadrant
      cornerIndex_valid obligations.toCompatibleLevelObligations h

/--
Unencoded domino undecidability from the finite-check-facing Robinson Section
7 board/free-line layer-patch obligation and generated position-coded
source-route obligations.
-/
theorem
...
/--
Encoded domino undecidability from the finite-check-facing Robinson Section 7
board/free-line layer-patch obligation and the generated interior position-code
rows.
-/
theorem
  ...
  exact
    encoded_domino_problem_undecidable_of_figure13_compatible_level_obligations_interiorRows
      activeSiteSpecs activeSiteSpecs_valid cornerIndex cornerQuadrant
      cornerIndex_valid obligations.toCompatibleLevelObligations
      hinterior hcorrect

/--
Unencoded domino undecidability from the finite-check-facing Robinson Section
7 board/free-line layer-patch obligation and the generated interior
position-code rows.
-/
theorem
...
Encoded domino undecidability from Robinson level board/free-grid geometry with
local Figure 18 site compatibility bundled into the generated level grids,
finite generated stack compatibility, finite scaffold/payload layer patches,
and generated position-coded source-route obligations.
-/
theorem
    encoded_domino_problem_undecidable_of_figure13_level_compatible_layer_patches_position_source
    (activeSiteSpecs : List (Nat × Quadrant))
    (activeSiteSpecs_valid :
      OllingerRobinson.Figure18Site.natSpecsValidBool activeSiteSpecs = true)
    (cornerIndex : Nat) (cornerQuadrant : Quadrant)
  ...
  exact
    encoded_domino_problem_undecidable_of_figure13_compatible_level_obligations_position_source
      activeSiteSpecs activeSiteSpecs_valid cornerIndex cornerQuadrant
      cornerIndex_valid
      (NatSiteRobinsonCompatibleLevelObligations.ofLevelCompatibleLayerPatches
        activeSiteSpecs activeSiteSpecs_valid cornerIndex cornerQuadrant
        cornerIndex_valid hgrids patches hcheck)
      h
...
-/
theorem
    domino_problem_undecidable_of_figure13_level_compatible_layer_patches_position_source
    (activeSiteSpecs : List (Nat × Quadrant))
    (activeSiteSpecs_valid :
      OllingerRobinson.Figure18Site.natSpecsValidBool activeSiteSpecs = true)
    (cornerIndex : Nat) (cornerQuadrant : Quadrant)
...
-/
theorem
    encoded_domino_problem_undecidable_of_figure13_level_compatible_layer_patches_interiorRows
    (activeSiteSpecs : List (Nat × Quadrant))
    (activeSiteSpecs_valid :
      OllingerRobinson.Figure18Site.natSpecsValidBool activeSiteSpecs = true)
    (cornerIndex : Nat) (cornerQuadrant : Quadrant)
...
-/
theorem
    domino_problem_undecidable_of_figure13_level_compatible_layer_patches_interiorRows
    (activeSiteSpecs : List (Nat × Quadrant))
    (activeSiteSpecs_valid :
      OllingerRobinson.Figure18Site.natSpecsValidBool activeSiteSpecs = true)
    (cornerIndex : Nat) (cornerQuadrant : Quadrant)
...
Encoded domino undecidability from Robinson level board/free-grid geometry with
local Figure 18 site compatibility bundled into the generated level grids,
finite generated stack compatibility, positive-radius indexed boxes, and
generated position-coded source-route obligations.  The radius-zero patch is
supplied by the scaffold corner tile.
-/
theorem
    encoded_domino_problem_undecidable_of_figure13_level_compatible_pos_boxes_position_source
    (activeSiteSpecs : List (Nat × Quadrant))
    (activeSiteSpecs_valid :
      OllingerRobinson.Figure18Site.natSpecsValidBool activeSiteSpecs = true)
    (cornerIndex : Nat) (cornerQuadrant : Quadrant)
  ...
  exact
    encoded_domino_problem_undecidable_of_figure13_compatible_level_obligations_position_source
      activeSiteSpecs activeSiteSpecs_valid cornerIndex cornerQuadrant
      cornerIndex_valid
      (NatSiteRobinsonCompatibleLevelObligations.ofLevelCompatiblePositiveBoxes
        activeSiteSpecs activeSiteSpecs_valid cornerIndex cornerQuadrant
        cornerIndex_valid hgrids hboxes_pos hcheck)
      h
...
-/
theorem
    domino_problem_undecidable_of_figure13_level_compatible_pos_boxes_position_source
    (activeSiteSpecs : List (Nat × Quadrant))
    (activeSiteSpecs_valid :
      OllingerRobinson.Figure18Site.natSpecsValidBool activeSiteSpecs = true)
    (cornerIndex : Nat) (cornerQuadrant : Quadrant)
...
Encoded domino undecidability from Robinson level board/free-grid geometry with
local Figure 18 site compatibility bundled into the generated level grids,
finite generated stack compatibility, positive-radius indexed boxes, and the
generated interior position-code rows.
-/
theorem
    encoded_domino_problem_undecidable_of_figure13_level_compatible_pos_boxes_interiorRows
    (activeSiteSpecs : List (Nat × Quadrant))
    (activeSiteSpecs_valid :
      OllingerRobinson.Figure18Site.natSpecsValidBool activeSiteSpecs = true)
    (cornerIndex : Nat) (cornerQuadrant : Quadrant)
...
-/
theorem
    domino_problem_undecidable_of_figure13_level_compatible_pos_boxes_interiorRows
    (activeSiteSpecs : List (Nat × Quadrant))
    (activeSiteSpecs_valid :
      OllingerRobinson.Figure18Site.natSpecsValidBool activeSiteSpecs = true)
    (cornerIndex : Nat) (cornerQuadrant : Quadrant)
...
Encoded domino undecidability from Robinson level board/free-grid geometry with
local Figure 18 site compatibility bundled into the generated level grids,
finite generated stack compatibility, positive-radius translated indexed boxes,
and generated position-coded source-route obligations.
-/
theorem
    encoded_domino_problem_undecidable_of_figure13_level_compatible_tpos_position_source
    (activeSiteSpecs : List (Nat × Quadrant))
    (activeSiteSpecs_valid :
      OllingerRobinson.Figure18Site.natSpecsValidBool activeSiteSpecs = true)
    (cornerIndex : Nat) (cornerQuadrant : Quadrant)
  ...
  exact
    encoded_domino_problem_undecidable_of_figure13_compatible_level_obligations_position_source
      ...
      (NatSiteRobinsonCompatibleLevelObligations.ofLevelCompatiblePositiveTranslatedBoxes
        activeSiteSpecs activeSiteSpecs_valid cornerIndex cornerQuadrant
        cornerIndex_valid hgrids translatedBoxes_pos hcheck)
      h
...
-/
theorem
    domino_problem_undecidable_of_figure13_level_compatible_translated_pos_boxes_position_source
    (activeSiteSpecs : List (Nat × Quadrant))
    (activeSiteSpecs_valid :
      OllingerRobinson.Figure18Site.natSpecsValidBool activeSiteSpecs = true)
    (cornerIndex : Nat) (cornerQuadrant : Quadrant)
...
-/
theorem
    encoded_domino_problem_undecidable_of_figure13_level_compatible_tpos_interiorRows
    (activeSiteSpecs : List (Nat × Quadrant))
    (activeSiteSpecs_valid :
      OllingerRobinson.Figure18Site.natSpecsValidBool activeSiteSpecs = true)
    (cornerIndex : Nat) (cornerQuadrant : Quadrant)
...
-/
theorem
    domino_problem_undecidable_of_figure13_level_compatible_translated_pos_boxes_interiorRows
    (activeSiteSpecs : List (Nat × Quadrant))
    (activeSiteSpecs_valid :
      OllingerRobinson.Figure18Site.natSpecsValidBool activeSiteSpecs = true)
    (cornerIndex : Nat) (cornerQuadrant : Quadrant)
...
/--
Encoded domino undecidability from the first audited L2-blank candidate via
tiling-dependent Robinson geometry, translated active-box obligations, and the
...
-/
theorem
    encoded_domino_problem_undecidable_l2c1_geom_combined_tower_obligations_interiorRows
    (O : NatSiteRobinsonGeomCombinedTranslatedPositiveBoxObligations
      l2Component1BlankCandidateActiveSiteSpecs
      l2Component1BlankCandidateSanity.activeSiteSpecs_valid
      0 Quadrant.southwest
...
-/
theorem
    domino_problem_undecidable_l2c1_geom_combined_tower_obligations_interiorRows
    (O : NatSiteRobinsonGeomCombinedTranslatedPositiveBoxObligations
      l2Component1BlankCandidateActiveSiteSpecs
      l2Component1BlankCandidateSanity.activeSiteSpecs_valid
      0 Quadrant.southwest
...
-/
theorem
    encoded_domino_problem_undecidable_l2c2_geom_combined_tower_obligations_interiorRows
    (O : NatSiteRobinsonGeomCombinedTranslatedPositiveBoxObligations
      l2Component2BlankCandidateActiveSiteSpecs
      l2Component2BlankCandidateSanity.activeSiteSpecs_valid
      0 Quadrant.northeast
...
-/
theorem
    domino_problem_undecidable_l2c2_geom_combined_tower_obligations_interiorRows
    (O : NatSiteRobinsonGeomCombinedTranslatedPositiveBoxObligations
      l2Component2BlankCandidateActiveSiteSpecs
      l2Component2BlankCandidateSanity.activeSiteSpecs_valid
      0 Quadrant.northeast
...
open NatSiteRobinsonOriginZeroTranslatedPositiveBoxObligations in
def l2c1OriginZeroFig13BoxBundledObligations
    (originZeroWindows :
      OllingerRobinson.HasFigure18IndexedActiveCornerOriginZeroWindowsForTable
        (scaffoldDataOfNatSites
          l2Component1BlankCandidateActiveSiteSpecs
    ...
    NatSiteRobinsonOriginZeroTranslatedPositiveBoxObligations
      ...
      0 Quadrant.southwest
      l2Component1BlankCandidateSanity.cornerIndex_valid :=
  ofL2C1Figure18ScaffoldDataPositiveFig13TileableBoxes
    originZeroWindows hboxes

open NatSiteRobinsonOriginZeroTranslatedPositiveBoxObligations in
def l2c2OriginZeroFig13BoxBundledObligations
    (originZeroWindows :
      OllingerRobinson.HasFigure18IndexedActiveCornerOriginZeroWindowsForTable
        (scaffoldDataOfNatSites
          l2Component2BlankCandidateActiveSiteSpecs
    ...
    NatSiteRobinsonOriginZeroTranslatedPositiveBoxObligations
      ...
      0 Quadrant.northeast
      l2Component2BlankCandidateSanity.cornerIndex_valid :=
  ofL2C2Figure18ScaffoldDataPositiveFig13TileableBoxes
    originZeroWindows hboxes

def l2c1OriginZeroSignalTowerFig13BundledObligations
    (originZeroWindows :
      OllingerRobinson.HasFigure18IndexedActiveCornerOriginZeroWindowsForTable
        (scaffoldDataOfNatSites
          l2Component1BlankCandidateActiveSiteSpecs
...
the Robinson Section 7 compatible-level certificate route.
-/
theorem
