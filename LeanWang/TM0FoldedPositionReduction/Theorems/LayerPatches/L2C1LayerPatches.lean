...
/-!
L2C1 layer-patch final theorem wrappers for the generated position-coded folded reduction.
-/
...
/--
Encoded domino undecidability from the first checked-stack/layer-patch Section 7
certificate and interior generated position-code rows at concrete numeric
label slots, with `positionProgramData` semantic correctness discharged.
-/
theorem encoded_domino_problem_undecidable_l2c1_checked_stack_layer_patches_interiorRowsAtIndexCorrect
    (data : L2C1CheckedStackLayerPatchData)
...
discharged.
-/
theorem domino_problem_undecidable_l2c1_checked_stack_layer_patches_interiorRowsAtIndexCorrect
    (data : L2C1CheckedStackLayerPatchData)
    (hinterior : SourcePositionCodeInteriorRowsAtIndexPrimrec) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  domino_problem_undecidable_l2c1_checked_stack_layer_patches_position_source
...
-/
theorem encoded_domino_problem_undecidable_l2c1_checked_stack_layer_patches_searchCodeWithNodupCorrect
    (data : L2C1CheckedStackLayerPatchData)
...
-/
theorem domino_problem_undecidable_l2c1_checked_stack_layer_patches_searchCodeWithNodupCorrect
    (data : L2C1CheckedStackLayerPatchData)
    (hsearch : SourceSearchCodeLabelIndexFromPrimrec)
    (hnodup : SourceStatementListNodup) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
...
-/
theorem encoded_domino_problem_undecidable_l2c1_checked_stack_layer_patches_searchCodeWithPairwiseDisjointCorrect
    (data : L2C1CheckedStackLayerPatchData)
    (hsearch : SourceSearchCodeLabelIndexFromPrimrec)
    (hstmt : SourceStartedTM1StatementSupportNodup)
    (hdisj : SourceStartedTM1StatementSupportPairwiseDisjoint) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  encoded_domino_problem_undecidable_l2c1_checked_stack_layer_patches_searchCodeWithNodupCorrect
    data hsearch
...
position-coded source route.
-/
theorem domino_problem_undecidable_l2c1_checked_stack_layer_patches_searchCodeWithPairwiseDisjointCorrect
    (data : L2C1CheckedStackLayerPatchData)
    (hsearch : SourceSearchCodeLabelIndexFromPrimrec)
    (hstmt : SourceStartedTM1StatementSupportNodup)
    (hdisj : SourceStartedTM1StatementSupportPairwiseDisjoint) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  domino_problem_undecidable_l2c1_checked_stack_layer_patches_searchCodeWithNodupCorrect
    data hsearch
    (sourceStatementListNodup_of_startedTM1StatementSupportPairwiseDisjoint
      hstmt hdisj)
