...
/-! Cached exceptional family-target checks for parents 52 through 55. -/
...
theorem completeEven13 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨13, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd13 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨13, by decide⟩ = true := by
  native_decide
