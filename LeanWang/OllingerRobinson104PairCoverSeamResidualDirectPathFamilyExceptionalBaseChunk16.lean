...
/-! Cached exceptional family-target checks for parents 64 through 67. -/
...
theorem completeEven16 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨16, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd16 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨16, by decide⟩ = true := by
  native_decide
