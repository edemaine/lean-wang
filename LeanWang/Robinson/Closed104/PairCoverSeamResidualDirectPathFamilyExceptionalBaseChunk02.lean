...
/-! Cached exceptional family-target checks for parents 8 through 11. -/
...
theorem completeEven02 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨2, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd02 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨2, by decide⟩ = true := by
  native_decide
