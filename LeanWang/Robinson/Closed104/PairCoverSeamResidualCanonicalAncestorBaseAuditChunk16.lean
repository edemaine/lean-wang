...
/-! Cached even and odd base-ancestor checks for parents 64 through 67. -/

namespace LeanWang.OllingerRobinson.Figure13Layers.Closed104
namespace PairCoverSeamResidualCanonicalAncestorBaseAudit

set_option linter.style.nativeDecide false in
theorem completeEven16 : ∀ parent : Index, 64 ≤ parent.val → parent.val < 68 →
    checkParent .even parent = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd16 : ∀ parent : Index, 64 ≤ parent.val → parent.val < 68 →
