...
/-! Cached exceptional family-target checks for parents 100 through 103. -/
...
theorem completeEven25 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨25, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd25 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨25, by decide⟩ = true := by
  native_decide
