...
/-! Cached even and odd base-ancestor checks for parents 84 through 87. -/

namespace LeanWang.OllingerRobinson.Figure13Layers.Closed104
namespace PairCoverSeamResidualCanonicalAncestorBaseAudit

set_option linter.style.nativeDecide false in
theorem completeEven21 : ∀ parent : Index, 84 ≤ parent.val → parent.val < 88 →
    checkParent .even parent = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd21 : ∀ parent : Index, 84 ≤ parent.val → parent.val < 88 →
