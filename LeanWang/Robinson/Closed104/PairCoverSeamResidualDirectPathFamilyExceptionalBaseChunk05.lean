...
/-! Cached exceptional family-target checks for parents 20 through 23. -/
...
theorem completeEven05 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨5, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd05 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨5, by decide⟩ = true := by
  native_decide
