...
/-! Cached even and odd base-ancestor checks for parents 88 through 91. -/

namespace LeanWang.OllingerRobinson.Figure13Layers.Closed104
namespace PairCoverSeamResidualCanonicalAncestorBaseAudit

set_option linter.style.nativeDecide false in
theorem completeEven22 : ∀ parent : Index, 88 ≤ parent.val → parent.val < 92 →
    checkParent .even parent = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd22 : ∀ parent : Index, 88 ≤ parent.val → parent.val < 92 →
