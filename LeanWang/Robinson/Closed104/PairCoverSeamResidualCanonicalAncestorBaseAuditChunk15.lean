...
/-! Cached even and odd base-ancestor checks for parents 60 through 63. -/

namespace LeanWang.OllingerRobinson.Figure13Layers.Closed104
namespace PairCoverSeamResidualCanonicalAncestorBaseAudit

set_option linter.style.nativeDecide false in
theorem completeEven15 : ∀ parent : Index, 60 ≤ parent.val → parent.val < 64 →
    checkParent .even parent = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd15 : ∀ parent : Index, 60 ≤ parent.val → parent.val < 64 →
