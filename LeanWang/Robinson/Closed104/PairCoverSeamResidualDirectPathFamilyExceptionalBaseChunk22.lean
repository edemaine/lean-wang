...
/-! Cached exceptional family-target checks for parents 88 through 91. -/
...
theorem completeEven22 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨22, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd22 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨22, by decide⟩ = true := by
  native_decide
