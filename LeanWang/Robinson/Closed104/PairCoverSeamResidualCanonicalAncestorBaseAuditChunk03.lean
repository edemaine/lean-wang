...
/-! Cached even and odd base-ancestor checks for parents 12 through 15. -/

namespace LeanWang.OllingerRobinson.Figure13Layers.Closed104
namespace PairCoverSeamResidualCanonicalAncestorBaseAudit

set_option linter.style.nativeDecide false in
theorem completeEven03 : ∀ parent : Index, 12 ≤ parent.val → parent.val < 16 →
    checkParent .even parent = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd03 : ∀ parent : Index, 12 ≤ parent.val → parent.val < 16 →
