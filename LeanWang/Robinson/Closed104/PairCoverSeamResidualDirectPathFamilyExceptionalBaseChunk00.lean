...
/-! Cached exceptional family-target checks for parents 0 through 3. -/
...
theorem completeEven00 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨0, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd00 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨0, by decide⟩ = true := by
  native_decide
