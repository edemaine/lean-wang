...
/-! Cached exceptional family-target checks for parents 36 through 39. -/
...
theorem completeEven09 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨9, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd09 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨9, by decide⟩ = true := by
  native_decide
