...
/-! Cached even and odd base-ancestor checks for parents 8 through 11. -/

namespace LeanWang.OllingerRobinson.Figure13Layers.Closed104
namespace PairCoverSeamResidualCanonicalAncestorBaseAudit

set_option linter.style.nativeDecide false in
theorem completeEven02 : ∀ parent : Index, 8 ≤ parent.val → parent.val < 12 →
    checkParent .even parent = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd02 : ∀ parent : Index, 8 ≤ parent.val → parent.val < 12 →
