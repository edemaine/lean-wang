...
/-! Cached even and odd base-ancestor checks for parents 92 through 95. -/

namespace LeanWang.OllingerRobinson.Figure13Layers.Closed104
namespace PairCoverSeamResidualCanonicalAncestorBaseAudit

set_option linter.style.nativeDecide false in
theorem completeEven23 : ∀ parent : Index, 92 ≤ parent.val → parent.val < 96 →
    checkParent .even parent = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd23 : ∀ parent : Index, 92 ≤ parent.val → parent.val < 96 →
