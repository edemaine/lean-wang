...
-/
import LeanWang.Robinson.Closed104.PairCoverSeamResidualDirectPathAllFamilyTargetsCreated
import LeanWang.Robinson.Closed104.PairCoverSeamResidualDirectPathExactPredecessorQueryCases
import LeanWang.Robinson.Closed104.PairCoverSeamResidualDirectPathFamilyExceptionalTargets
...
theorem columnSucc
  ...
  rcases verticalExactInheritedSource phase (depth + 1) grid
      parentX parentY boundaryWest boundaryEast rowSouth.le rowNorth
