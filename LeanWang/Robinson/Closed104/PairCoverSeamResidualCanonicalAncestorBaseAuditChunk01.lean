...
/-! Cached even and odd base-ancestor checks for parents 4 through 7. -/

namespace LeanWang.OllingerRobinson.Figure13Layers.Closed104
namespace PairCoverSeamResidualCanonicalAncestorBaseAudit

set_option linter.style.nativeDecide false in
theorem completeEven01 : ∀ parent : Index, 4 ≤ parent.val → parent.val < 8 →
    checkParent .even parent = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd01 : ∀ parent : Index, 4 ≤ parent.val → parent.val < 8 →
