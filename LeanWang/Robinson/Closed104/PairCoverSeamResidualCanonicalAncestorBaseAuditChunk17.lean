...
/-! Cached even and odd base-ancestor checks for parents 68 through 71. -/

namespace LeanWang.OllingerRobinson.Figure13Layers.Closed104
namespace PairCoverSeamResidualCanonicalAncestorBaseAudit

set_option linter.style.nativeDecide false in
theorem completeEven17 : ∀ parent : Index, 68 ≤ parent.val → parent.val < 72 →
    checkParent .even parent = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd17 : ∀ parent : Index, 68 ≤ parent.val → parent.val < 72 →
