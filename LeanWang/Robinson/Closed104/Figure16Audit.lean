...
Standalone checks and generic tiling infrastructure used to audit the human
Figure 16 transcription.  The active Robinson proof imports only
`Figure16.lean`; this module is retained as an independently buildable
reference.
-/
