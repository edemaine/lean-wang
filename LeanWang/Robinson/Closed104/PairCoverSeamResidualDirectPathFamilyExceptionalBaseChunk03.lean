...
/-! Cached exceptional family-target checks for parents 12 through 15. -/
...
theorem completeEven03 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨3, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd03 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨3, by decide⟩ = true := by
  native_decide
