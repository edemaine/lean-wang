...
/-! Cached exceptional family-target checks for parents 84 through 87. -/
...
theorem completeEven21 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨21, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd21 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨21, by decide⟩ = true := by
  native_decide
