...
-/
import LeanWang.Robinson.Closed104.PairCoverSeamResidualDirectPathExactPredecessorQueryCases
import LeanWang.Robinson.Closed104.PairCoverSeamResidualDirectPathFamilyExceptionalBaseTransport
import LeanWang.Robinson.Closed104.PairCoverSeamResidualDirectPathFamilyTargetPathBase
import LeanWang.Robinson.Closed104.PairCoverSeamResidualDirectPathAllFamilyTargets

/-!
# Projection-closed odd depth-zero family targets
...
namespace PairCoverSeamResidualDirectPathAllFamilyTargetsOddBase
...
/-- Every odd depth-one retained-boundary query has a same-family endpoint
target, whether its free-line coordinate is retained or newly created. -/
theorem oddBase : AllFamilyTargetsAt .odd 0 := by
  constructor
...
end PairCoverSeamResidualDirectPathAllFamilyTargetsOddBase
