...
/-! Cached even and odd base-ancestor checks for parents 48 through 51. -/

namespace LeanWang.OllingerRobinson.Figure13Layers.Closed104
namespace PairCoverSeamResidualCanonicalAncestorBaseAudit

set_option linter.style.nativeDecide false in
theorem completeEven12 : ∀ parent : Index, 48 ≤ parent.val → parent.val < 52 →
    checkParent .even parent = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd12 : ∀ parent : Index, 48 ≤ parent.val → parent.val < 52 →
