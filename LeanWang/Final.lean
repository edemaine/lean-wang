...
the source-uniform generated decoder package for the folded TM0 reduction.
-/
...
`sourceRows` is the source-uniform generated position-code decoder package for
the folded TM0 reduction.
-/
...
theorem encoded_domino_problem_undecidable (h : FinalReductionInputs) :
  ...
  exact
    TM0FoldedReduction.encoded_domino_problem_undecidable_l2c1_checked_stack_layer_patches_interiorPackageCorrect
...
theorem domino_problem_undecidable (h : FinalReductionInputs) :
  ...
  exact
    TM0FoldedReduction.domino_problem_undecidable_l2c1_checked_stack_layer_patches_interiorPackageCorrect
      h.scaffold h.sourceRows
