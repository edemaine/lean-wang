...
`FinalReductionInputs`: a checked finite Section 7 scaffold package and
...
`scaffold` is the checked finite Section 7 scaffold certificate: origin-zero
checked stacks plus active-corner layer patches.
