...
`FinalReductionInputs`: an origin-zero Figure 13 scaffold package and
...
`scaffold` is the origin-zero Figure 13 finite-box scaffold certificate.
...
structure FinalReductionInputs : Prop where
  scaffold : TM0FoldedReduction.L2C1OriginZeroFig13BoxData
...
theorem encoded_domino_problem_undecidable (h : FinalReductionInputs) :
  ...
  exact
    TM0FoldedReduction.encoded_domino_problem_undecidable_l2c1_origin_zero_fig13_box_data_interiorRowsCorrect
...
theorem domino_problem_undecidable (h : FinalReductionInputs) :
  ...
  exact
    TM0FoldedReduction.domino_problem_undecidable_l2c1_origin_zero_fig13_box_data_interiorRowsCorrect
      h.scaffold h.sourceRows
