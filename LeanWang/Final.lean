...
set_option linter.style.longLine false in
/--
Encoded endpoint from second origin-zero active/corner windows, row-major
checked raw-boundary board levels, and the source-specialized position-code
label-index target, routed through Section 7 layer patches.
-/
theorem
    encoded_domino_problem_undecidable_of_l2c2OriginZeroCheckedBoardLevelsLayerPatchesSourcePositionCodeLabelIndexFrom
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevels : TM0FoldedReduction.Figure18CanonicalRawBoundaryCheckedBoardLevels)
    (labelIndex : SourcePositionCodeLabelIndexFromPrimrec) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  TM0FoldedReduction.encoded_domino_problem_undecidable_l2c2_origin_zero_checked_board_levels_layer_patches_sourceCodeCorrect
    originZeroWindows boardLevels labelIndex

set_option linter.style.longLine false in
/--
Unencoded endpoint from second origin-zero active/corner windows, row-major
checked raw-boundary board levels, and the source-specialized position-code
label-index target, routed through Section 7 layer patches.
-/
theorem
    domino_problem_undecidable_of_l2c2OriginZeroCheckedBoardLevelsLayerPatchesSourcePositionCodeLabelIndexFrom
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevels : TM0FoldedReduction.Figure18CanonicalRawBoundaryCheckedBoardLevels)
    (labelIndex : SourcePositionCodeLabelIndexFromPrimrec) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  TM0FoldedReduction.domino_problem_undecidable_l2c2_origin_zero_checked_board_levels_layer_patches_sourceCodeCorrect
    originZeroWindows boardLevels labelIndex

set_option linter.style.longLine false in
/--
Encoded endpoint from second origin-zero active/corner windows, row-major
checked raw-boundary board levels, and generated one-row position-code data,
routed through Section 7 layer patches.
-/
theorem
    encoded_domino_problem_undecidable_of_l2c2OriginZeroCheckedBoardLevelsLayerPatchesOneRows
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevels : TM0FoldedReduction.Figure18CanonicalRawBoundaryCheckedBoardLevels)
    (sourceRows : SourcePositionCodeOneRowsPrimrec) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  TM0FoldedReduction.encoded_domino_problem_undecidable_l2c2_origin_zero_checked_board_levels_layer_patches_oneRowsCorrect
    originZeroWindows boardLevels sourceRows
...
-/
theorem
    domino_problem_undecidable_of_l2c2OriginZeroCheckedBoardLevelsLayerPatchesOneRows
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevels : TM0FoldedReduction.Figure18CanonicalRawBoundaryCheckedBoardLevels)
    (sourceRows : SourcePositionCodeOneRowsPrimrec) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  TM0FoldedReduction.domino_problem_undecidable_l2c2_origin_zero_checked_board_levels_layer_patches_oneRowsCorrect
    originZeroWindows boardLevels sourceRows

set_option linter.style.longLine false in
/--
Encoded endpoint from second origin-zero active/corner windows, row-major
checked raw-boundary board levels, and generated bounded-interior position-code
rows, routed through Section 7 layer patches.
-/
theorem
    encoded_domino_problem_undecidable_of_l2c2OriginZeroCheckedBoardLevelsLayerPatchesBoundedRows
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevels : TM0FoldedReduction.Figure18CanonicalRawBoundaryCheckedBoardLevels)
    (sourceRows : SourcePositionCodeBoundedInteriorRowsPrimrec) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  TM0FoldedReduction.encoded_domino_problem_undecidable_l2c2_origin_zero_checked_board_levels_layer_patches_boundedRowsCorrect
    originZeroWindows boardLevels sourceRows
...
-/
theorem
    domino_problem_undecidable_of_l2c2OriginZeroCheckedBoardLevelsLayerPatchesBoundedRows
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevels : TM0FoldedReduction.Figure18CanonicalRawBoundaryCheckedBoardLevels)
    (sourceRows : SourcePositionCodeBoundedInteriorRowsPrimrec) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  TM0FoldedReduction.domino_problem_undecidable_l2c2_origin_zero_checked_board_levels_layer_patches_boundedRowsCorrect
    originZeroWindows boardLevels sourceRows

set_option linter.style.longLine false in
/--
Encoded endpoint from second origin-zero active/corner windows, row-major
checked raw-boundary board levels, and generated interior position-code rows,
routed through Section 7 layer patches.
-/
theorem
    encoded_domino_problem_undecidable_of_l2c2OriginZeroCheckedBoardLevelsLayerPatchesInteriorRows
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevels : TM0FoldedReduction.Figure18CanonicalRawBoundaryCheckedBoardLevels)
    (sourceRows : SourcePositionCodeInteriorRowsPrimrec) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  TM0FoldedReduction.encoded_domino_problem_undecidable_l2c2_origin_zero_checked_board_levels_layer_patches_interiorRowsCorrect
    originZeroWindows boardLevels sourceRows
...
-/
theorem
    domino_problem_undecidable_of_l2c2OriginZeroCheckedBoardLevelsLayerPatchesInteriorRows
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevels : TM0FoldedReduction.Figure18CanonicalRawBoundaryCheckedBoardLevels)
    (sourceRows : SourcePositionCodeInteriorRowsPrimrec) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  TM0FoldedReduction.domino_problem_undecidable_l2c2_origin_zero_checked_board_levels_layer_patches_interiorRowsCorrect
    originZeroWindows boardLevels sourceRows

set_option linter.style.longLine false in
/--
Encoded endpoint from second origin-zero active/corner windows, finite checked
raw-boundary board-level checks, and the source-specialized position-code
label-index target, routed through Section 7 layer patches.
-/
theorem
    encoded_domino_problem_undecidable_of_l2c2OriginZeroBoardLevelChecksLayerPatchesSourcePositionCodeLabelIndexFrom
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevelChecks : TM0FoldedReduction.Figure18CanonicalRawBoundaryBoardLevelChecks)
    (labelIndex : SourcePositionCodeLabelIndexFromPrimrec) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  TM0FoldedReduction.encoded_domino_problem_undecidable_l2c2_origin_zero_board_level_checks_layer_patches_sourceCodeCorrect
    originZeroWindows boardLevelChecks labelIndex

set_option linter.style.longLine false in
/--
Unencoded endpoint from second origin-zero active/corner windows, finite
checked raw-boundary board-level checks, and the source-specialized
position-code label-index target, routed through Section 7 layer patches.
-/
theorem
    domino_problem_undecidable_of_l2c2OriginZeroBoardLevelChecksLayerPatchesSourcePositionCodeLabelIndexFrom
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevelChecks : TM0FoldedReduction.Figure18CanonicalRawBoundaryBoardLevelChecks)
    (labelIndex : SourcePositionCodeLabelIndexFromPrimrec) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  TM0FoldedReduction.domino_problem_undecidable_l2c2_origin_zero_board_level_checks_layer_patches_sourceCodeCorrect
    originZeroWindows boardLevelChecks labelIndex

set_option linter.style.longLine false in
/--
Encoded endpoint from second origin-zero active/corner windows, finite checked
raw-boundary board-level checks, and generated one-row position-code data,
routed through Section 7 layer patches.
-/
theorem
    encoded_domino_problem_undecidable_of_l2c2OriginZeroBoardLevelChecksLayerPatchesOneRows
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevelChecks : TM0FoldedReduction.Figure18CanonicalRawBoundaryBoardLevelChecks)
    (sourceRows : SourcePositionCodeOneRowsPrimrec) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  TM0FoldedReduction.encoded_domino_problem_undecidable_l2c2_origin_zero_board_level_checks_layer_patches_oneRowsCorrect
    originZeroWindows boardLevelChecks sourceRows

set_option linter.style.longLine false in
/--
Unencoded endpoint from second origin-zero active/corner windows, finite
checked raw-boundary board-level checks, and generated one-row position-code
data, routed through Section 7 layer patches.
-/
theorem
    domino_problem_undecidable_of_l2c2OriginZeroBoardLevelChecksLayerPatchesOneRows
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevelChecks : TM0FoldedReduction.Figure18CanonicalRawBoundaryBoardLevelChecks)
    (sourceRows : SourcePositionCodeOneRowsPrimrec) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  TM0FoldedReduction.domino_problem_undecidable_l2c2_origin_zero_board_level_checks_layer_patches_oneRowsCorrect
    originZeroWindows boardLevelChecks sourceRows

set_option linter.style.longLine false in
/--
Encoded endpoint from second origin-zero active/corner windows, finite checked
raw-boundary board-level checks, and generated bounded-interior position-code
rows, routed through Section 7 layer patches.
-/
theorem
    encoded_domino_problem_undecidable_of_l2c2OriginZeroBoardLevelChecksLayerPatchesBoundedRows
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevelChecks : TM0FoldedReduction.Figure18CanonicalRawBoundaryBoardLevelChecks)
    (sourceRows : SourcePositionCodeBoundedInteriorRowsPrimrec) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  TM0FoldedReduction.encoded_domino_problem_undecidable_l2c2_origin_zero_board_level_checks_layer_patches_boundedRowsCorrect
    originZeroWindows boardLevelChecks sourceRows

set_option linter.style.longLine false in
/--
Unencoded endpoint from second origin-zero active/corner windows, finite
checked raw-boundary board-level checks, and generated bounded-interior
position-code rows, routed through Section 7 layer patches.
-/
theorem
    domino_problem_undecidable_of_l2c2OriginZeroBoardLevelChecksLayerPatchesBoundedRows
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevelChecks : TM0FoldedReduction.Figure18CanonicalRawBoundaryBoardLevelChecks)
    (sourceRows : SourcePositionCodeBoundedInteriorRowsPrimrec) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  TM0FoldedReduction.domino_problem_undecidable_l2c2_origin_zero_board_level_checks_layer_patches_boundedRowsCorrect
    originZeroWindows boardLevelChecks sourceRows

set_option linter.style.longLine false in
/--
Encoded endpoint from second origin-zero active/corner windows, finite checked
raw-boundary board-level checks, and generated interior position-code rows,
routed through Section 7 layer patches.
-/
theorem
    encoded_domino_problem_undecidable_of_l2c2OriginZeroBoardLevelChecksLayerPatchesInteriorRows
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevelChecks : TM0FoldedReduction.Figure18CanonicalRawBoundaryBoardLevelChecks)
    (sourceRows : SourcePositionCodeInteriorRowsPrimrec) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  TM0FoldedReduction.encoded_domino_problem_undecidable_l2c2_origin_zero_board_level_checks_layer_patches_interiorRowsCorrect
    originZeroWindows boardLevelChecks sourceRows

set_option linter.style.longLine false in
/--
Unencoded endpoint from second origin-zero active/corner windows, finite
checked raw-boundary board-level checks, and generated interior position-code
rows, routed through Section 7 layer patches.
-/
theorem
    domino_problem_undecidable_of_l2c2OriginZeroBoardLevelChecksLayerPatchesInteriorRows
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (boardLevelChecks : TM0FoldedReduction.Figure18CanonicalRawBoundaryBoardLevelChecks)
    (sourceRows : SourcePositionCodeInteriorRowsPrimrec) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  TM0FoldedReduction.domino_problem_undecidable_l2c2_origin_zero_board_level_checks_layer_patches_interiorRowsCorrect
    originZeroWindows boardLevelChecks sourceRows
