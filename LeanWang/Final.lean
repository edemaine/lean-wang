...
set_option linter.style.longLine false in
/--
Second-candidate checked-stack Figure 16 route with generated interior
position-code rows.

Checked stacks are the finite Figure 13/Figure 16 decoding target for the
origin-zero active/corner windows; compatible Figure 16 level checks supply the
finite layer patches.
-/
structure FinalL2C2Figure16CompatibleCheckedStacksConstructionObligations :
    Prop where
...
set_option linter.style.longLine false in
/--
Second-candidate checked-stack Figure 16 route with the generated position-code
decoder step.
-/
structure FinalL2C2Figure16CompatibleCheckedStacksDecoderStepConstructionObligations :
    Prop where
  checkedStacks : TM0FoldedReduction.L2C2OriginZeroCheckedStacks
  compatibleLevelChecks :
    TM0FoldedReduction.Figure18CanonicalCheckedRecognizedCompatibleLevelChecks
...
set_option linter.style.longLine false in
/--
Second-candidate checked-stack Figure 16 route with the global position-code
label-index source target.
-/
structure FinalL2C2Figure16CompatibleCheckedStacksGlobalPositionCodeConstructionObligations :
    Prop where
  checkedStacks : TM0FoldedReduction.L2C2OriginZeroCheckedStacks
  compatibleLevelChecks :
    TM0FoldedReduction.Figure18CanonicalCheckedRecognizedCompatibleLevelChecks
...
set_option linter.style.longLine false in
/--
Second-candidate checked-stack Figure 16 route with the source-specialized
position-code label-index source target.
-/
structure FinalL2C2Figure16CompatibleCheckedStacksSourcePositionCodeConstructionObligations :
    Prop where
  checkedStacks : TM0FoldedReduction.L2C2OriginZeroCheckedStacks
  compatibleLevelChecks :
    TM0FoldedReduction.Figure18CanonicalCheckedRecognizedCompatibleLevelChecks
...
namespace FinalL2C2Figure16CompatibleCheckedStacksConstructionObligations

set_option linter.style.longLine false in
/--
Project the checked-stack/Figure 16 row-source package to the
checked-stack/layer-patch row-source package.
-/
def toCheckedStackLayerPatchConstructionObligations
    (h : FinalL2C2Figure16CompatibleCheckedStacksConstructionObligations) :
  ...
  scaffold :=
    l2c2CheckedStackLayerPatchDataOfCheckedStacksCompatibleFig16LevelChecks
      h.checkedStacks h.compatibleLevelChecks
  sourceRows := h.sourceRows

set_option linter.style.longLine false in
/--
Project the checked-stack/Figure 16 row-source package to the source-label
package.
-/
def toSourcePositionCodeConstructionObligations
    (h : FinalL2C2Figure16CompatibleCheckedStacksConstructionObligations) :
    FinalL2C2Figure16CompatibleCheckedStacksSourcePositionCodeConstructionObligations where
  checkedStacks := h.checkedStacks
...
set_option linter.style.longLine false in
/--
Encoded endpoint from second-candidate checked origin-zero stacks, compatible
Figure 16 level checks, and generated interior position-code rows.
-/
theorem encoded_domino_problem_undecidable
    (h : FinalL2C2Figure16CompatibleCheckedStacksConstructionObligations) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  h.toCheckedStackLayerPatchConstructionObligations
    |>.encoded_domino_problem_undecidable
...
end FinalL2C2Figure16CompatibleCheckedStacksConstructionObligations

namespace FinalL2C2Figure16CompatibleCheckedStacksDecoderStepConstructionObligations

set_option linter.style.longLine false in
/--
Project the checked-stack/Figure 16 decoder-step package to the
checked-stack/layer-patch decoder-step package.
-/
def toCheckedStackLayerPatchDecoderStepConstructionObligations
    (h : FinalL2C2Figure16CompatibleCheckedStacksDecoderStepConstructionObligations) :
    FinalL2C2CheckedStackLayerPatchDecoderStepConstructionObligations where
  scaffold :=
    l2c2CheckedStackLayerPatchDataOfCheckedStacksCompatibleFig16LevelChecks
      h.checkedStacks h.compatibleLevelChecks
...
/--
Encoded endpoint from second-candidate checked origin-zero stacks, compatible
Figure 16 level checks, and the generated position-code decoder step.
-/
theorem encoded_domino_problem_undecidable
    (h : FinalL2C2Figure16CompatibleCheckedStacksDecoderStepConstructionObligations) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  h.toCheckedStackLayerPatchDecoderStepConstructionObligations
    |>.encoded_domino_problem_undecidable

set_option linter.style.longLine false in
/--
Wang domino undecidability from second-candidate checked origin-zero stacks,
compatible Figure 16 level checks, and the generated position-code decoder
step.
-/
theorem domino_problem_undecidable
    (h : FinalL2C2Figure16CompatibleCheckedStacksDecoderStepConstructionObligations) :
...
end FinalL2C2Figure16CompatibleCheckedStacksDecoderStepConstructionObligations

namespace FinalL2C2Figure16CompatibleCheckedStacksGlobalPositionCodeConstructionObligations

set_option linter.style.longLine false in
/--
Project the checked-stack/Figure 16 global-label package to the source-label
package.
-/
def toSourcePositionCodeConstructionObligations
    (h : FinalL2C2Figure16CompatibleCheckedStacksGlobalPositionCodeConstructionObligations) :
    FinalL2C2Figure16CompatibleCheckedStacksSourcePositionCodeConstructionObligations where
  checkedStacks := h.checkedStacks
  compatibleLevelChecks := h.compatibleLevelChecks
  labelIndex := sourceLabelIndexPrimrec_of_globalLabelIndex h.labelIndex
...
set_option linter.style.longLine false in
/--
Project the checked-stack/Figure 16 global-label package to the
...
/--
Encoded endpoint from second-candidate checked origin-zero stacks, compatible
Figure 16 level checks, and the global position-code label-index target.
-/
theorem encoded_domino_problem_undecidable
    (h : FinalL2C2Figure16CompatibleCheckedStacksGlobalPositionCodeConstructionObligations) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  h.toCheckedStackLayerPatchGlobalPositionCodeConstructionObligations
    |>.encoded_domino_problem_undecidable

set_option linter.style.longLine false in
/--
Wang domino undecidability from second-candidate checked origin-zero stacks,
compatible Figure 16 level checks, and the global position-code label-index
target.
-/
theorem domino_problem_undecidable
    (h : FinalL2C2Figure16CompatibleCheckedStacksGlobalPositionCodeConstructionObligations) :
...
end FinalL2C2Figure16CompatibleCheckedStacksGlobalPositionCodeConstructionObligations

namespace FinalL2C2Figure16CompatibleCheckedStacksSourcePositionCodeConstructionObligations

set_option linter.style.longLine false in
/--
Project the checked-stack/Figure 16 source-label package to the
checked-stack/layer-patch source-label package.
-/
def toCheckedStackLayerPatchSourcePositionCodeConstructionObligations
    (h : FinalL2C2Figure16CompatibleCheckedStacksSourcePositionCodeConstructionObligations) :
    FinalL2C2CheckedStackLayerPatchSourcePositionCodeConstructionObligations where
  scaffold :=
    l2c2CheckedStackLayerPatchDataOfCheckedStacksCompatibleFig16LevelChecks
      h.checkedStacks h.compatibleLevelChecks
...
set_option linter.style.longLine false in
/--
Project the checked-stack/Figure 16 source-label package to the decoder-step
package.
-/
def toDecoderStepConstructionObligations
    (h : FinalL2C2Figure16CompatibleCheckedStacksSourcePositionCodeConstructionObligations) :
    FinalL2C2Figure16CompatibleCheckedStacksDecoderStepConstructionObligations where
  checkedStacks := h.checkedStacks
  compatibleLevelChecks := h.compatibleLevelChecks
  decoderStep := sourceDecoderStepPrimrec_of_sourceLabelIndex h.labelIndex
...
theorem encoded_domino_problem_undecidable
    (h : FinalL2C2Figure16CompatibleCheckedStacksSourcePositionCodeConstructionObligations) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  h.toCheckedStackLayerPatchSourcePositionCodeConstructionObligations
    |>.encoded_domino_problem_undecidable
...
end FinalL2C2Figure16CompatibleCheckedStacksSourcePositionCodeConstructionObligations
...
set_option linter.style.longLine false in
/--
Encoded Wang domino undecidability from the second-candidate origin-zero/Figure
16 row-source final package.
-/
theorem encoded_domino_problem_undecidable_of_l2c2Figure16CompatibleOriginZeroConstructionObligations
    (h : FinalL2C2Figure16CompatibleOriginZeroConstructionObligations) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  h.encoded_domino_problem_undecidable
...
set_option linter.style.longLine false in
/--
Wang domino undecidability from the second-candidate origin-zero/Figure 16
row-source final package.
-/
theorem domino_problem_undecidable_of_l2c2Figure16CompatibleOriginZeroConstructionObligations
    (h : FinalL2C2Figure16CompatibleOriginZeroConstructionObligations) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  h.domino_problem_undecidable
...
16 source-specialized final package.
-/
theorem encoded_domino_problem_undecidable_of_l2c2Figure16CompatibleOriginZeroSourcePositionCodeConstructionObligations
    (h : FinalL2C2Figure16CompatibleOriginZeroSourcePositionCodeConstructionObligations) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  h.encoded_domino_problem_undecidable
...
/--
Wang domino undecidability from the second-candidate origin-zero/Figure 16
source-specialized final package.
-/
theorem domino_problem_undecidable_of_l2c2Figure16CompatibleOriginZeroSourcePositionCodeConstructionObligations
    (h : FinalL2C2Figure16CompatibleOriginZeroSourcePositionCodeConstructionObligations) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  h.domino_problem_undecidable
...
set_option linter.style.longLine false in
/--
Encoded Wang domino undecidability from the second-candidate checked-stack /
Figure 16 row-source final package.
-/
theorem encoded_domino_problem_undecidable_of_l2c2Figure16CompatibleCheckedStacksConstructionObligations
    (h : FinalL2C2Figure16CompatibleCheckedStacksConstructionObligations) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  h.encoded_domino_problem_undecidable
...
set_option linter.style.longLine false in
/--
Wang domino undecidability from the second-candidate checked-stack / Figure 16
row-source final package.
-/
theorem domino_problem_undecidable_of_l2c2Figure16CompatibleCheckedStacksConstructionObligations
    (h : FinalL2C2Figure16CompatibleCheckedStacksConstructionObligations) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  h.domino_problem_undecidable
...
/--
Encoded Wang domino undecidability from the second-candidate checked-stack /
Figure 16 decoder-step final package.
-/
theorem encoded_domino_problem_undecidable_of_l2c2Figure16CompatibleCheckedStacksDecoderStepConstructionObligations
    (h : FinalL2C2Figure16CompatibleCheckedStacksDecoderStepConstructionObligations) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  h.encoded_domino_problem_undecidable
...
/--
Wang domino undecidability from the second-candidate checked-stack / Figure 16
decoder-step final package.
-/
theorem domino_problem_undecidable_of_l2c2Figure16CompatibleCheckedStacksDecoderStepConstructionObligations
    (h : FinalL2C2Figure16CompatibleCheckedStacksDecoderStepConstructionObligations) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  h.domino_problem_undecidable
...
/--
Encoded Wang domino undecidability from the second-candidate checked-stack /
Figure 16 global-label final package.
-/
theorem encoded_domino_problem_undecidable_of_l2c2Figure16CompatibleCheckedStacksGlobalPositionCodeConstructionObligations
    (h :
      FinalL2C2Figure16CompatibleCheckedStacksGlobalPositionCodeConstructionObligations) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  h.encoded_domino_problem_undecidable
...
/--
Wang domino undecidability from the second-candidate checked-stack / Figure 16
global-label final package.
-/
theorem domino_problem_undecidable_of_l2c2Figure16CompatibleCheckedStacksGlobalPositionCodeConstructionObligations
    (h :
      FinalL2C2Figure16CompatibleCheckedStacksGlobalPositionCodeConstructionObligations) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  h.domino_problem_undecidable
...
/--
Encoded Wang domino undecidability from the second-candidate checked-stack /
Figure 16 source-specialized final package.
-/
theorem encoded_domino_problem_undecidable_of_l2c2Figure16CompatibleCheckedStacksSourcePositionCodeConstructionObligations
    (h :
      FinalL2C2Figure16CompatibleCheckedStacksSourcePositionCodeConstructionObligations) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  h.encoded_domino_problem_undecidable
...
source-specialized final package.
-/
theorem domino_problem_undecidable_of_l2c2Figure16CompatibleCheckedStacksSourcePositionCodeConstructionObligations
    (h :
      FinalL2C2Figure16CompatibleCheckedStacksSourcePositionCodeConstructionObligations) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  h.domino_problem_undecidable
...
set_option linter.style.longLine false in
/--
Encoded Wang domino undecidability from second-candidate origin-zero
recognition, finite Figure 16 compatible level checks, and the
source-specialized position-code label-index source target.
-/
theorem encoded_domino_problem_undecidable_of_l2c2OriginZeroAndCompatibleFig16LevelChecksSourcePositionCodeLabelIndexFrom
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (compatibleLevelChecks :
      TM0FoldedReduction.Figure18CanonicalCheckedRecognizedCompatibleLevelChecks)
    (labelIndex : SourcePositionCodeLabelIndexFromPrimrec) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  encoded_domino_problem_undecidable_of_l2c2Figure16CompatibleOriginZeroSourcePositionCodeConstructionObligations
...
set_option linter.style.longLine false in
/--
Wang domino undecidability from second-candidate origin-zero recognition,
finite Figure 16 compatible level checks, and the source-specialized
position-code label-index source target.
-/
theorem domino_problem_undecidable_of_l2c2OriginZeroAndCompatibleFig16LevelChecksSourcePositionCodeLabelIndexFrom
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (compatibleLevelChecks :
      TM0FoldedReduction.Figure18CanonicalCheckedRecognizedCompatibleLevelChecks)
    (labelIndex : SourcePositionCodeLabelIndexFromPrimrec) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  domino_problem_undecidable_of_l2c2Figure16CompatibleOriginZeroSourcePositionCodeConstructionObligations
    { originZeroWindows := originZeroWindows
      compatibleLevelChecks := compatibleLevelChecks
      labelIndex := labelIndex }
...
position-code rows.
-/
theorem encoded_domino_problem_undecidable_of_l2c2OriginZeroAndCompatibleFig16LevelChecksSourcePositionCodeInteriorRows
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (compatibleLevelChecks :
      TM0FoldedReduction.Figure18CanonicalCheckedRecognizedCompatibleLevelChecks)
    (sourceRows : TM0FoldedReduction.SourcePositionCodeInteriorRowsPrimrec) :
    ¬ ComputablePred (fun n : Nat => TilesPlane (decodeTileSet n)) :=
  encoded_domino_problem_undecidable_of_l2c2Figure16CompatibleOriginZeroConstructionObligations
    { originZeroWindows := originZeroWindows
      compatibleLevelChecks := compatibleLevelChecks
      sourceRows := sourceRows }
...
rows.
-/
theorem domino_problem_undecidable_of_l2c2OriginZeroAndCompatibleFig16LevelChecksSourcePositionCodeInteriorRows
    (originZeroWindows : TM0FoldedReduction.L2C2OriginZeroWindows)
    (compatibleLevelChecks :
      TM0FoldedReduction.Figure18CanonicalCheckedRecognizedCompatibleLevelChecks)
    (sourceRows : TM0FoldedReduction.SourcePositionCodeInteriorRowsPrimrec) :
    ¬ ComputablePred (fun T : TileSet => TilesPlane T) :=
  domino_problem_undecidable_of_l2c2Figure16CompatibleOriginZeroConstructionObligations
    { originZeroWindows := originZeroWindows
      compatibleLevelChecks := compatibleLevelChecks
      sourceRows := sourceRows }
