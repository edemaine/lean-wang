...
/-! Cached even and odd base-ancestor checks for parents 80 through 83. -/

namespace LeanWang.OllingerRobinson.Figure13Layers.Closed104
namespace PairCoverSeamResidualCanonicalAncestorBaseAudit

set_option linter.style.nativeDecide false in
theorem completeEven20 : ∀ parent : Index, 80 ≤ parent.val → parent.val < 84 →
    checkParent .even parent = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd20 : ∀ parent : Index, 80 ≤ parent.val → parent.val < 84 →
