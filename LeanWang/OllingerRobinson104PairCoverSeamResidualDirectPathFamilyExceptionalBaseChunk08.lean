...
/-! Cached exceptional family-target checks for parents 32 through 35. -/
...
theorem completeEven08 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨8, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd08 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨8, by decide⟩ = true := by
  native_decide
