...
/-! Cached canonical certificate 6 for the even seam-path base. -/

namespace LeanWang
namespace OllingerRobinson
namespace Figure13Layers
namespace Closed104
namespace PairCoverSeamPathEvenBaseChunk06
...
theorem complete : checkChunk .even 1 evenRoots ⟨6, by decide⟩ = true := by
...
end PairCoverSeamPathEvenBaseChunk06
end Closed104
end Figure13Layers
