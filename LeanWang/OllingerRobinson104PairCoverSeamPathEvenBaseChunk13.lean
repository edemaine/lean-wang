...
/-! Cached canonical certificate 13 for the even seam-path base. -/

namespace LeanWang
namespace OllingerRobinson
namespace Figure13Layers
namespace Closed104
namespace PairCoverSeamPathEvenBaseChunk13
...
theorem complete : checkChunk .even 1 evenRoots ⟨13, by decide⟩ = true := by
...
end PairCoverSeamPathEvenBaseChunk13
end Closed104
end Figure13Layers
