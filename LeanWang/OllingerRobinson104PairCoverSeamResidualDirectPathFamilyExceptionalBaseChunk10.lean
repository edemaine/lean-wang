...
/-! Cached exceptional family-target checks for parents 40 through 43. -/
...
theorem completeEven10 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨10, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd10 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨10, by decide⟩ = true := by
  native_decide
