...
/-! Cached exceptional family-target checks for parents 72 through 75. -/
...
theorem completeEven18 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨18, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd18 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨18, by decide⟩ = true := by
  native_decide
