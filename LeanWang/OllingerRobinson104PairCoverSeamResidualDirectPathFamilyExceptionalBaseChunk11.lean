...
/-! Cached exceptional family-target checks for parents 44 through 47. -/
...
theorem completeEven11 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨11, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd11 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨11, by decide⟩ = true := by
  native_decide
