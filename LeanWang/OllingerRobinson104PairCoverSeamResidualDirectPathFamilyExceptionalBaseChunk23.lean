...
/-! Cached exceptional family-target checks for parents 92 through 95. -/
...
theorem completeEven23 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨23, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd23 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨23, by decide⟩ = true := by
  native_decide
