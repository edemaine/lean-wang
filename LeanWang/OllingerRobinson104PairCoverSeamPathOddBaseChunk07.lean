...
/-! Cached canonical certificate 07 for the odd seam-path base. -/

namespace LeanWang
namespace OllingerRobinson
namespace Figure13Layers
namespace Closed104
namespace PairCoverSeamPathOddBaseChunk07

open ShadedFreeLineRecurrence PairCoverSeamPathComponentCertificate

set_option linter.style.nativeDecide false in
theorem complete : checkChunk .odd 0 oddRoots ⟨7, by decide⟩ = true := by
...
end PairCoverSeamPathOddBaseChunk07
end Closed104
end Figure13Layers
