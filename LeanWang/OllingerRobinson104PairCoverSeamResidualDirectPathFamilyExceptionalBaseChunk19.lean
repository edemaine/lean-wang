...
/-! Cached exceptional family-target checks for parents 76 through 79. -/
...
theorem completeEven19 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨19, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd19 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨19, by decide⟩ = true := by
  native_decide
