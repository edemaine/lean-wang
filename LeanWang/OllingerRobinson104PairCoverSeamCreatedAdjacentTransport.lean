...
import LeanWang.OllingerRobinson104PairCoverSeamCreatedAdjacentComponents
...
/-- Created boundary in the lower cell, queried across its north edge. -/
theorem verticalLower
  ...
  have localInterior : Signals.horizontalInterior?
    ...
    exact hinterior
  have localPath := (verticalPairPaths hpair).lower
    hcolumn hboundary localInterior
  simpa using rectangularVerticalSeamPath_verticalWindow
    grid blockX blockY hcolumn' (by omega) (by omega) localPath

/-- Created boundary in the upper cell, queried across its south edge. -/
theorem verticalUpper
  ...
  have localInterior : Signals.horizontalInterior?
    ...
    exact hinterior
  have localPath := (verticalPairPaths hpair).upper
    hcolumn hboundary localInterior
  simpa using rectangularVerticalSeamPath_verticalWindow
    grid blockX blockY hcolumn' (by omega) (by omega) localPath

/-- Created boundary in the left cell, queried across its east edge. -/
theorem horizontalLeft
  ...
  have localInterior : Signals.verticalInterior?
    ...
    exact hinterior
  have localPath := (horizontalPairPaths hpair).left
    hrow hboundary localInterior
  simpa using rectangularHorizontalSeamPath_horizontalWindow
    grid blockX blockY hrow' (by omega) (by omega) localPath

/-- Created boundary in the right cell, queried across its west edge. -/
theorem horizontalRight
  ...
  have localInterior : Signals.verticalInterior?
    ...
    exact hinterior
  have localPath := (horizontalPairPaths hpair).right
    hrow hboundary localInterior
  simpa using rectangularHorizontalSeamPath_horizontalWindow
    grid blockX blockY hrow' (by omega) (by omega) localPath
