...
/-! Cached exceptional family-target checks for parents 80 through 83. -/
...
theorem completeEven20 :
    checkChunk .even 0 (exhaustiveFuel .even 0) ⟨20, by decide⟩ = true := by
  native_decide

set_option linter.style.nativeDecide false in
theorem completeOdd20 :
    checkChunk .odd 0 (exhaustiveFuel .odd 0) ⟨20, by decide⟩ = true := by
  native_decide
